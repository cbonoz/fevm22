...
Datamarket is a blockchain product tracking platform for any dataset.
...
Every completed datamarket update via the QR code emits a 'DataMarketEvent' that gets indexed and appended to the dataset's contract.
